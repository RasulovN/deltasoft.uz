      ...
      <Box sx={{ mb: 5 }}>
        ...
        <Grid item xs={12} lg={12} md={4}>
          <Card sx={{ display: 'block', height: '100%' }}>
            <CardContent>
              <Typography variant="h6">{t('contact.contactDetails')}</Typography>
        ...
        <Grid item xs={12} lg={12} md={4}>
          <Card sx={{ display: 'block', height: '100%' }}>
            <CardContent>
              <Typography variant="h6">{t('contact.followUs')}</Typography>
              <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2 }}>
                <Link to={`https://t.me/deltasoft_uz`} target="_blank">
                  <FaTelegramPlane style={{ fontSize: '30px', cursor: 'pointer', color: 'blue' }} />
                </Link>
                <Link to={`https://instagram.com/deltasoft.uz`} target="_blank">
                  <Instagram style={{ fontSize: '30px', cursor: 'pointer', color: '#cd486b' }} />
                </Link>
                <Link to={`https://www.linkedin.com/company/deltasoftuz`} target="_blank">
                  <LinkedIn style={{ fontSize: '30px', cursor: 'pointer', color: 'blue' }} />
                </Link>
                <Link to={`https://www.facebook.com/deltasoftuz/`} target="_blank">
                  <Facebook style={{ fontSize: '30px', cursor: 'pointer', color: 'blue' }} />
                </Link>
              </Box>
            </CardContent>
          </Card>

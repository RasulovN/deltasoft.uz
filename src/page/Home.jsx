        ...
        <Container>
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                    <Typography variant="h6">{t('homePage.softwareDevelopment')}</Typography>
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                />
                <CardContent sx={{ flexGrow: 1 }}>
                    <Typography variant="h6">{t('homePage.cybersecurity')}</Typography>
                    <Typography variant="body2" color="text.secondary">
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                />
                <CardContent sx={{ flexGrow: 1 }}>
                    <Typography variant="h6">{t('homePage.cloudSolutions')}</Typography>
                    <Typography variant="body2" color="text.secondary">
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                />
                <CardContent sx={{ flexGrow: 1 }}>
                    <Typography variant="h6">{t('homePage.consulting')}</Typography>
                    <Typography variant="body2" color="text.secondary">
        ...
        <Container>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={4}>
              <Typography variant="h6">{t('homePage.expertTeam')}</Typography>
